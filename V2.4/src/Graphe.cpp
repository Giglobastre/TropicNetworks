...
void Graphe::affiche_graphe()
{
    ...
    while(var_quit_affiche!=1)
    {
        ...
        for(int i=0 ; i<m_ordre ; i++)
        {
            ...
            if(mouse_b &1 && mouse_x>m_Sommets[i].getPos_x()-20 && mouse_x<m_Sommets[i].getPos_x()+20 && mouse_y>m_Sommets[i].getPos_y()-20 && mouse_y<m_Sommets[i].getPos_y()+20)
            {
                while(mouse_b &1)
                {
                    m_Sommets[i].setPos_x(mouse_x);
                    m_Sommets[i].setPos_y(mouse_y);
                    circlefill(page,mouse_x,mouse_y,10,makecol(255,0,0));//affichage de la souris
                    circlefill(page,m_Sommets[i].getPos_x(),m_Sommets[i].getPos_y(),20,makecol(255,255,255));
                }
            }
            ...
            line(page,0,384,100,384,makecol(0,0,0));//ligne de separation centrale
