...
/// A DECOMMENTER POUR PROG FINAL (car on veut afficher que le sommet 0)
  ...
  for(int i=0 ; i< m_ordre ; i++)
        {
            ///Ligne 362 à commenter/supprimer pour prog final (car on veut afficher que le sommet 0)
            m_Sommets[i].affiche(page);
