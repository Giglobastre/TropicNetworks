...
///ERREUR : ce programme n'arrive pas à charger les images comme demandé, après de nombreux test il nous a été impossible d'identifier
///les raisons du crash qu'il provoquait, nous utiliserons donc les noms des sommets pour l'affichage du graphe.
void Sommet::affiche(BITMAP * page)
{

    textprintf_centre_ex(page,font,getPos_x()-100,getPos_y()-100,makecol(0,0,0),-1,m_nom.c_str());
